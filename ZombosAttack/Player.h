...
public:
	...
	/// \ brief : arguement constructor, calls base constructor 
	...
	/// \ brief : calls base destructor
	/// \ params : none
	/// \ precons : none
	/// \ return :  none
	~Player();

	/// \ brief : Moves player, updates gun location, bullet locations and draws 
	...
	/// \ brief : creates and binds a gun to the player
	...
	/// \ brief : draws the player it's gun into the input window
	/// \ params : window  to draw into
	/// \ precons : window is instantiated
	/// \ return : none
	void draw(sf::RenderWindow &window);

	/// \ brief : custom set texture that sets origin to center of sprite
	/// \ params : texture to give to player
	/// \ precons : texture is valid
	/// \ return : none
	void setTexture(const sf::Texture &texture);

	/// \ brief : returns a pointer to player's gun
	/// \ params : none
	/// \ precons : nnoe
