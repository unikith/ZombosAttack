...
{
public:
	/// \ breif : determines whether or not a transformable object is within the input window
	...
	/// \ breif : corrects x and y position seperatly if ooutside window to keep the object in the window
...
private:
	/// \ breif : returns if object is above the window
	...
	/// \ breif : returns if object is below the window
	/// \ params : object is a transformable that is checked against window
	/// \ precons : object and window are initiated objects
	...
	/// \ breif : returns if object is right of the window
	/// \ params : object is a transformable that is checked against window
	/// \ precons : object and window are initiated objects
	...
	/// \ breif : returns if object is left of the window
	/// \ params : object is a transformable that is checked against window
	/// \ precons : object and window are initiated objects
